...
namespace NL.Rijksoverheid.CoronaTester.BackEnd.Common.Web.Models
{
    ...
    {
        [JsonPropertyName("androidMinimumVersion")]
        public int AndroidMinimumVersion { get; set; }

        [JsonPropertyName("androidMinimumVersionMessage")]
        public string AndroidMinimumVersionMessage { get; set; }

        [JsonPropertyName("playStoreURL")]
        public string PlayStoreUrl { get; set; }

        [JsonPropertyName("iosMinimumVersion")]
        public string IosMinimumVersion { get; set; }

        [JsonPropertyName("iosMinimumVersionMessage")]
        public string IosMinimumVersionMessage { get; set; }

        [JsonPropertyName("iosAppStoreURL")]
        ...
        [JsonPropertyName("proofOfTestValidity")]
        public int ProofOfTestValidity { get; set; }
    }
}
