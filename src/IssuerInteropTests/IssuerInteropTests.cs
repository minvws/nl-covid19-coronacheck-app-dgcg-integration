...
namespace NL.Rijksoverheid.CoronaTester.BackEnd.IssuerInteropTests
{
    public class IssuerInteropTests
    {
        ...
        public void TestsIssueProof()
        {
            ...
            var issuerNonceB64 = "v4oiye1Eu3tMKDBiiBl0WA==";
            var attributes = JsonSerializer.Serialize(new ProofOfTestAttributes(DateTime.UtcNow.ToString("o"),"PCR"));
            ...
            var result = issuer.IssueProof(issuerPkXml, issuerSkXml, issuerNonceB64, commitments, attributes);
