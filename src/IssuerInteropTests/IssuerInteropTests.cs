...
namespace NL.Rijksoverheid.CoronaTester.BackEnd.IssuerInteropTests
{
    public class IssuerInteropTests
    {
        ...
        public void TestsIssueProof()
        {
            ...
            var issuerNonceB64 = @"hgc3oMZzWd/rEcjdpHsNnw=="; // RYAN: this example was generated by calling GenerateNonce()
            var attributes = JsonSerializer.Serialize(new[] { DateTime.UtcNow.ToString("o"), "testType" });
