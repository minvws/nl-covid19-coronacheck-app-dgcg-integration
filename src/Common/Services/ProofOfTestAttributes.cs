...
namespace NL.Rijksoverheid.CoronaTester.BackEnd.Common.Services
{
    public class ProofOfTestAttributes
    {
        ...
        /// </summary>
        [JsonPropertyName("sampleTime")] public string SampleTime { get; }

        /// <summary>
        /// Well known string identifying the type of test.
        /// </summary>
        [JsonPropertyName("testType")] public string TestType { get; }

        /// <summary>
        /// Flag to show whether it's a specimen ("1") or not ("0")
        /// </summary>
        [JsonPropertyName("isPaperProof")] public string IsPaperProof { get; }

        /// <summary>
        /// Flag to show whether it's a specimen ("1") or not ("0")
        /// </summary>
        [JsonPropertyName("isSpecimen")] public string IsSpecimen { get; }

        /// <summary>
        /// A-Z{1}
        /// </summary>
        [JsonPropertyName("firstNameInitial")] public string FirstNameInitial { get;  }

        /// <summary>
        /// A-Z{1}
        /// </summary>
        [JsonPropertyName("lastNameInitial")] public string LastNameInitial { get; }

        /// <summary>
        /// 1-31 or X
        /// </summary>
        [JsonPropertyName("birthDay")] public string BirthDay { get; }

        /// <summary>
        /// 1-12 or X
        /// </summary>
        [JsonPropertyName("birthMonth")] public string BirthMonth { get; }
    }
}