...
namespace NL.Rijksoverheid.CoronaTester.BackEnd.Common.Services
{
    public interface IProofOfTestService
    {
        ...
        /// <returns>ISM as JSON string, Attributes as string array</returns>
        (string, string[]) GetProofOfTest(string testType, string dateTime, string nonce, string commitments);
